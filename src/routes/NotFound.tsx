...
function PageNotFound() {
	return (
		<div className="bg-transparent px-4 py-32 sm:px-6 sm:py-44 md:grid md:place-items-center lg:px-8">
				...
				<main className="sm:flex">
					...
					<div className="sm:ml-6">
						<div className="sm:border-l sm:border-gray-200 dark:border-gray-700 sm:pl-6">
							<h1 className="text-4xl font-extrabold text-gray-900 dark:text-gray-50 tracking-tight sm:text-5xl">Page not found</h1>
